...
1.  **Ejecución de Automatización:**
    ...
    *   Verifica la creación de la nueva nota en `wiki/daily/YYYY-MM-DD.md`.
...
3.  **Actualización de la Wiki:**
    *   Si encuentras un frigorífico o zona específica con problemas críticos, actualiza o crea una nota en `wiki/entities/`.
    *   Si hay cambios en la interpretación de la Res. 841/2025, actualiza `wiki/entities/Resolucion SENASA 841-2025.md`.
    *   Agrega nuevos reportes de fallas técnicas a `wiki/concepts/`.

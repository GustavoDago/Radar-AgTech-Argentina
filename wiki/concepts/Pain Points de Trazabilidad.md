...
- **Resolución 841/2025:** Obligatoriedad de lectura electrónica para todos los movimientos a partir de 2026. Re-ratificada el 30/06/2026. La falta de infraestructura (lectores, conectividad) es un cuello de botella crítico.
- **Implementación Inmediata en Frigoríficos (01/07/2026):** Los frigoríficos deben comenzar a implementar validaciones de trazabilidad electrónica para evitar cuellos de botella en la recepción, generando una demanda de software tipo "buffer".

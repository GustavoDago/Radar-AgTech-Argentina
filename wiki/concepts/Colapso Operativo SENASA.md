...
- **Alianza Público-Privada (Abril 2026):** Firma de un convenio con el Consejo Agroindustrial Argentino (CAA) para recibir "apoyo tecnológico y técnico". Esto confirma la incapacidad del Estado para mantener los sistemas por cuenta propia y la apertura a soluciones externas.
...
- **Necesidad de Redundancia:** El software debe permitir la carga offline de movimientos y la sincronización asincrónica con SIGSA cuando este esté disponible.
